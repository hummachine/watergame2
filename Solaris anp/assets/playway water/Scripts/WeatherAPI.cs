...
public class WeatherAPI : MonoBehaviour {
	...
	public TOD_WeatherManager.RainType rainType;
	public TOD_WeatherManager.CloudType cloudType;
	public TOD_WeatherManager.AtmosphereType atmosphereType;

	IEnumerator CheckWeather() {
		while (true) {
			string weatherUrl = "http://api.openweathermap.org/data/2.5/weather?lat=17.7500&lon=142.5000&appid=e72fb8413ce86ecd7c649b180210f7bb";
			...
			case "531":
				...
				Debug.Log("rain");
				rainType = TOD_WeatherManager.RainType.Heavy;
				cloudType = TOD_WeatherManager.CloudType.Broken;
				atmosphereType = TOD_WeatherManager.AtmosphereType.Fog;
				break;
			case "600":
			case "601":
			case "602":
