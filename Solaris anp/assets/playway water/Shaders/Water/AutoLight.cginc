...
#define TRANSFER_VERTEX_TO_FRAGMENT(a) a._LightCoord = mul(unity_WorldToLight, posWorld).xyz; TRANSFER_SHADOW(a)
...
#define TRANSFER_VERTEX_TO_FRAGMENT(a) a._LightCoord = mul(unity_WorldToLight, posWorld); TRANSFER_SHADOW(a)
...
#define TRANSFER_VERTEX_TO_FRAGMENT(a) a._LightCoord = mul(unity_WorldToLight, posWorld).xy; TRANSFER_SHADOW(a)
