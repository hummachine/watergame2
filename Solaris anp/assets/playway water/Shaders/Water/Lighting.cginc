...
#include "../Water/UnityGlobalIllumination.cginc"
...
inline void LightingLambert_GI (
	...
	inout UnityGI gi)
{
	gi = UnityGlobalIllumination (data, 1.0, 0.0, s.Normal, false, 0.0);
}
...
inline void LightingBlinnPhong_GI (
	...
	inout UnityGI gi)
{
	gi = UnityGlobalIllumination (data, 1.0, s.Gloss, s.Normal, false, 1.0);
}
