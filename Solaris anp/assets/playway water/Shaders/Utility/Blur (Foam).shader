...
Shader "PlayWay Water/Utilities/Blur (Foam)"
{
	Properties
	{
		_MainTex ("", 2D) = "" {}
	...
	sampler2D _MainTex;
	half2 _Offset;
	half4 _Weights[4] = { half4(0.0205,0.0205,0.0205,0.0205), half4(0.0855,0.0855,0.0855,0.0855), half4(0.232,0.232,0.232,0.232), half4(0.324,0.324,0.324,0.324) };
